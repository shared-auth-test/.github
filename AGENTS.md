...
These instructions apply to automation and coding agents working in `shared-auth-test` repositories unless a repository defines stricter local policy.
...
- GitHub organization: https://github.com/shared-auth-test
- Public organization defaults: https://github.com/shared-auth-test/.github
...
3. Review linked pull requests, issues, Linear work, related repositories in `shared-auth-test`, and relevant external-organization repositories whenever behavior or contracts cross boundaries.
