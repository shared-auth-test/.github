...
- **GitHub organization:** [shared-auth-test](https://github.com/shared-auth-test)
- **Canonical GitHub Project:** [shared-auth-test-project](https://github.com/orgs/shared-auth-test/projects/1) (project 1)
- **Canonical Linear project:** [planning workspace](https://linear.app/denman/project/githubcomshared-auth-test-b01af6233a25)
- **Organization documentation repository:** [shared-auth-test/.github](https://github.com/shared-auth-test/.github)
